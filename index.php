    ...
    <header class="site-header js-site-header">
      <div class="container-fluid">
        <div class="row align-items-center">
          <div class="col-6 col-lg-4 site-logo aos-init aos-animate" data-aos="fade"><a href="CINQ_CINQ.html">Sauvons L'Autiste </a></div>
          <div class="col-6 col-lg-8">
             <span style="margin-left: 500px">  <span class="col-6 col-lg-4 " data-aos="fade"><a href="connexion/index.php">Connexion</a></span>
             <span class="col-6 col-lg-4 "data-aos="fade"><a href="inscription/index.php">Inscription</a></span></span>
                  ...
                  <div class="row full-height align-items-center">
                    <div class="col-md-6 mx-auto">
                      <ul class="list-unstyled menu">
                        <li class="active"><a href="CINQ_CINQ.html">Accueil</a></li>
                        <li ><a href="Apropos.html">A Propos </a></li>
                        <li><a href="Aide.html">Aide & Support</a></li>
                        <li><a href="">Fonctinnalités</a>
                         <ol><a href="#">Afficher les médecins disponible</a></ol>
                         <ol><a href="Lignes.html">Afficher les centres disponible</a></ol>
                         <ol><a href="#">Documentation Autism</a></ol>
                         <ol><a href="#">je m'inquiète pour mon enfant, est il autiste?</a></ol></li>
                      </ul>
                    </div>
                  </div>
                </div>
      ...
      <div class="container">
        <div class="row site-hero-inner justify-content-center align-items-center">
          <div class="col-md-10 text-center aos-init aos-animate" data-aos="fade-up">
            ...
            <h1 class="heading"> Ouvrons La Bulle .. </h1>
          </div>
        </div>
      </div>
     <!-- Fin section -->  
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-md-12 col-lg-7 ml-auto order-lg-2 position-relative mb-5 aos-init" data-aos="fade-up">
            ...
            <img src="IMG/2.png" alt="Image" class="img-fluid rounded">
          </div>
          <div class="col-md-12 col-lg-4 order-lg-1 aos-init" data-aos="fade-up">
            <h2 class="heading">  <b>Bienvenu</b>!</h2>
            <p class="mb-4"> .</p>
            <p><a href="Aide.html" class="btn btn-primary text-white py-2 mr-3">En savoir plus</a> <span class="mr-3 font-family-serif"><em>ou</em></span> <a href="https://vimeo.com/channels/staffpicks/93951774"  data-fancybox class="text-uppercase letter-spacing-1">Video</a></p><p><a href="https://web.facebook.com/CINQ-CINQ-464308584125662/?modal=admin_todo_tour" class="btn btn-primary text-white py-2 mr-3" style="color: blue">Facebook</a></p>
          </div>
    ...
    <section class="section testimonial-section">
      <div class="container">
        <div class="row justify-content-center text-center mb-5">
          <div class="col-md-7">
            <h2 class="heading" data-aos="fade-up">Les gents disent..</h2>
          </div>
        </div>
        <div class="row">
          <div class="js-carousel-2 owl-carousel mb-5" data-aos="fade-up" data-aos-delay="200">
            ...
            <div class="testimonial text-center slider-item">
              <div class="author-image mb-3">
                <img src="IMG/person_4.jpg" alt="Image placeholder" class="rounded-circle mx-auto">
              </div>
              <blockquote>

                <p>&ldquo;Ce site web est ......&rdquo;</p>
              </blockquote>
              <p><em>&mdash; Zack Cena</em></p>
            </div> 
